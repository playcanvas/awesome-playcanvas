...
- [playcanvas-opti-pixel](https://github.com/AlexAPPi/playcanvas-opti-pixel) - Advanced rendering toolkit for PlayCanvas: hardware instancing, BVH-accelerated frustum/occlusion culling, hierarchical LOD, and GPU-driven cluster culling.
...
- [Quake](https://github.com/willeastcott/playcanvas-quake) - A port of id Software's Quake to PlayCanvas.
